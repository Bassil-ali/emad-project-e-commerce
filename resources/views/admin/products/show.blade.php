...
<div class="card card-default">
	<div class="card-header">
		...
		<div class="btn-group">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item" href="{{aurl('products/'.$products->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">			<div class="col-md-12 col-lg-12 col-xs-12">
			...
			{{-- <div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.number_of_calories')}} :</b>
				{!! $products->number_of_calories !!}
			</div> --}}
			...
			<div class="col-md-6 col-lg-6 col-xs-6">
				...
				@endphp
					<li>{{ $ingredient->$ingredient_property }}</li>
				@endforeach
