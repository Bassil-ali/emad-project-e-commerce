	...
	<div class="card-header">
		...
		<div class="btn-group">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('distributorsdata/'.$distributorsdata->id)}}" class="dropdown-item">
...
<form action="{{aurl('/distributorsdata/'.$distributorsdata->id)}}"  class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" id="distributorsdata">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <input type="text" id="title" name="title" value="{{ $distributorsdata->title }}" class="form-control" placeholder="{{trans('admin.title')}}" />
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        name="description" >{{ $distributorsdata->description }}</textarea>
    </div>
</div>
