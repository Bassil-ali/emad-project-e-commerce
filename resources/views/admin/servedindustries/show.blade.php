...
<div class="card card-default">
	<div class="card-header">
		...
		<div class="btn-group">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item" href="{{aurl('servedindustries/'.$servedindustries->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$servedindustries->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.title_ar')}} :</b>
				{!! $servedindustries->title_ar !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.title_en')}} :</b>
				{!! $servedindustries->title_en !!}
			</div>
