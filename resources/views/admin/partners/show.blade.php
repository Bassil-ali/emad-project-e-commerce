...
<div class="card card-default">
	<div class="card-header">
		...
		<div class="btn-group">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item" href="{{aurl('partners/'.$partners->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$partners->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.Partner_Type')}} :</b>
				...
				<b>{{trans('admin.email_address')}} :</b>
				{!! $partners->email_address !!}
			</div>
