...
<form action="{{aurl('/abouts')}}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="post" id="abouts">
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        <label for="titile_ar" class=" control-label">{{trans('admin.titile_ar')}}</label>
            <input type="text" id="titile_ar" name="titile_ar" value="{{old('titile_ar')}}" class="form-control" placeholder="{{trans('admin.titile_ar')}}" />
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
