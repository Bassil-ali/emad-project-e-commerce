...
<div class="card card-default">
	<div class="card-header">
		...
		<div class="btn-group">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item" href="{{aurl('homepagemain/'.$homepagemain->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$homepagemain->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.first_title_ar')}} :</b>
				{!! $homepagemain->first_title_ar !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.description_ar')}} :</b>
				{!! $homepagemain->description_ar !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.second_title_ar')}} :</b>
				{!! $homepagemain->second_title_ar !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.YouTupe_url')}} :</b>
				{!! $homepagemain->YouTupe_url !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.workers')}} :</b>
				{!! $homepagemain->workers !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.certificates')}} :</b>
				{!! $homepagemain->certificates !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.clients')}} :</b>
				{!! $homepagemain->clients !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.first_title_en')}} :</b>
				{!! $homepagemain->first_title_en !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.description_en')}} :</b>
				{!! $homepagemain->description_en !!}
			</div>
			<div class="col-md-6 col-lg-6 col-xs-6">
				<b>{{trans('admin.second_title_en')}} :</b>
				{!! $homepagemain->second_title_en !!}
			</div>
