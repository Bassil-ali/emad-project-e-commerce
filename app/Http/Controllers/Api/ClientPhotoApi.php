...
use Validator;
use App\Http\Controllers\Validations\ClientPhotoRequest;
// Auto Controller Maker By Baboon Script
// Baboon Maker has been Created And Developed By  [It V 1.6.8 | https://it.phpanonymous.com]
// Copyright Reserved  [It V 1.6.8 | https://it.phpanonymous.com]
class ClientPhotoApi extends Controller
{
    ...
    public function store(ClientPhotoRequest $request)
    {
    	$data = $request->except("_token");
              ...
              $data['client_photo'] = it()->upload('client_photo','clientphoto');
              }else{
                $data['client_photo'] = "";
              }
        ...
        return response([
            ...
            public function updateFillableColumns() {
				       $fillableCols = [];
				       foreach (array_keys((new ClientPhotoRequest)->attributes()) as $fillableUpdate) {
            ...
            public function destroy($id)
            {
              ...
              if(!empty($clientphoto->client_photo)){
               it()->delete($clientphoto->client_photo);
              }
