...
use App\SendEmail;
use Validator;
use App\Http\Controllers\Validations\SendEmailsControllerRequest;
// Auto Controller Maker By Baboon Script
// Baboon Maker has been Created And Developed By  [It V 1.6.8 | https://it.phpanonymous.com]
// Copyright Reserved  [It V 1.6.8 | https://it.phpanonymous.com]
class SendEmailsControllerApi extends Controller
{
             ...
             * @return \Illuminate\Http\Response
             */
    public function store(SendEmailsControllerRequest $request)
    {
        ...
        return response([
            ...
            public function updateFillableColumns() {
				       $fillableCols = [];
				       foreach (array_keys((new SendEmailsControllerRequest)->attributes()) as $fillableUpdate) {
            ...
            public function update(SendEmailsControllerRequest $request,$id)
            {
            	$SendEmail = SendEmail::find($id);
            	if(is_null($SendEmail) || empty($SendEmail)){
            	 return errorResponseJson([]);
