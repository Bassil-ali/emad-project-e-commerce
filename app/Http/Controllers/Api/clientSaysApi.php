...
class clientSaysApi extends Controller
{
            ...
            {
            	$clientSay = clientSay::orderBy('id','desc')->paginate(15);
               return response([
               "status"=>true,
               "statusCode"=>200,
               "data"=>$clientSay
    ...
    public function store(clientSaysRequest $request)
    {
        ...
        $clientSay = clientSay::create($data); 
        ...
        return response([
            ...
            public function show($id)
            {
            	...
            	if(is_null($clientSay) || empty($clientSay)){
