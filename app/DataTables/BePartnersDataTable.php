...
class BePartnersDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.bepartners.buttons.actions')
    ...
    {
        return BePartner::query()->select("be_partners.*");
