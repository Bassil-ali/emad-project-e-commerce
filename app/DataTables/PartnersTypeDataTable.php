...
class PartnersTypeDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.partnerstype.buttons.actions')
    ...
    {
        return PartnerType::query()->select("partner_types.*");
