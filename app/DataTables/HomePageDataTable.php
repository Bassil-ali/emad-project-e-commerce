...
class HomePageDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.homepage.buttons.actions')
            ->addColumn('client_photo', '{!! view("admin.show_image",["image"=>$client_photo])->render() !!}')
            ->addColumn('vedio', '{!! view("admin.show_video",["video"=>$vedio])->render() !!}')
            ...
            ->rawColumns(['checkbox','actions',"client_photo","vedio",]);
    }
	...
	public function query()
    {
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,1,3,1,4,1,7,1,8,1,9', 'input') . "
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'second_title',
                 'data'=>'second_title',
                 'title'=>trans('admin.second_title'),
		    ],
				[
                 'name'=>'client_photo',
                 'data'=>'client_photo',
                 'title'=>trans('admin.client_photo'),
		    ],
				[
                 'name'=>'vedio',
                 'data'=>'vedio',
                 'title'=>trans('admin.vedio'),
		    ],
				[
                 'name'=>'workers',
                 'data'=>'workers',
