...
class ServedIndustriesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.servedindustries.buttons.actions')
    ...
    {
        return ServedIndustrie::query()->select("served_industries.*");
