...
class BlogsDataTable extends DataTable
{
    ...
    {
        return Blog::query()->with(['category',])->select("blogs.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,1,3,1,7,1,8,1,9,1,10', 'input') . "
            ". filterElement('4', 'select', \App\Models\Category::pluck("name_ar","name_ar")) . "
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'category_id.name_ar',
                 'data'=>'category_id.name_ar',
				...
				[
                 'name'=>'product_url',
                 'data'=>'product_url',
                 'title'=>trans('admin.product_url'),
		    ],
				[
                 'name'=>'created_date',
                 'data'=>'created_date',
                 'title'=>trans('admin.created_date'),
		    ],
            [
	                'name' => 'created_at',
	                'data' => 'created_at',
