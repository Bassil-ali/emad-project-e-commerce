    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
           ...
           <label for="selectdata{{ $id }}"></label>
            ...
            ->rawColumns(['checkbox','actions',"main_photo","photos",]);
    }
	...
	public function query()
    {
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,1,3,1,4,1,5,1,8,1,9,1,10,1,11', 'input') . "
	    ...
	    protected function getColumns()
	    {
            ...
            [
                'name'=>'Category',
                'data'=>'category.name_'.app()->getLocale(),
            ...
            //      'title'=>trans('admin.number_of_calories'),
		    // ],
				[
                 'name'=>'description_ar',
                 'data'=>'description_ar',
