...
class DistributorsDataDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.distributorsdata.buttons.actions')
    ...
    {
        return DistributorsData::query()->select("distributors_datas.*");
