...
class ClientPhotosDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.clientphotos.buttons.actions')
		   ...
		   <label for="selectdata{{ $id }}"></label>
            ...
            ->rawColumns(['checkbox','actions',"client_photo",]);
    }
    ...
    {
        return ClientPhoto::query()->select("client_photos.*");
