...
class SendEmailsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.sendemails.buttons.actions')
    ...
    {
        return SendEmail::query()->select("send_emails.*");
